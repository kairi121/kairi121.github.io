...
import { Card, CardContent, CardHeader, Typography, List, ListItem, Link, CardActionArea } from '@mui/material';
import { useTranslation } from 'react-i18next';
import { styled } from '@mui/system';
import { Link as RouterLink } from 'react-router-dom'; // react-router-domからLinkをインポート
import AOS from 'aos';
...
const CardComponent = ({ titleKey, contentKey, isList = false, link }) => {
